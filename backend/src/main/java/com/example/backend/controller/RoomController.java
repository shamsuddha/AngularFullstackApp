...
public class RoomController {
  ...
  @PostMapping(value = "/search-with-floor")
  public @ResponseBody ResponseEntity<?> searchWithFloor() {
    return new ResponseEntity<>(this.roomService.searchWithFloor(), HttpStatus.OK);
  }
}
